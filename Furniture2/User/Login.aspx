<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Furniture2.User.Login" %>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form_container">
                        <img  id="userLogin" src="../Images/login.jpg" alt="loginImg" class="img-thumbnail"/>
                    </div>
                </div>
                    ...
                    <div class="form_container">
                       <div>
                        ...
                        <div class="btn-box">
                            ...
                            <span class="pl-3 text-info">New User? <a href="RegistrationForm.aspx" class="badge badge-info">Register Here..</a></span>
                        </div>
                    </div>
                </div>
            </div>
